...
city=st.selectbox("Select the city where match is being played",sorted(cities)) 
...
if st.button("Predict Probability"):
    ...
    st.header("Batting Team Chances:- "+str(round(winpro*100))+'%')
    st.header("Bowling Team Chances:- "+str(round(losspro*100))+'%')